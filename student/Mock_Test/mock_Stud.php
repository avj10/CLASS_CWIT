			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="#" class=""><i class="lnr lnr-chart-bars"></i> <span>Timetable</span></a></li>
						...
						<li><a href="About.php" class=""><i class="lnr lnr-linearicons"></i> <span>About Us</span></a></li>
					</ul>
				</nav>
			</div>
											  ...
											  ?>
												...
												if(isset($_SESSION['roll_no']))
												{
												 echo "<li><a href=\"../page-Student_profile.php\"><i class='lnr lnr-user'> </i><span>My Profile </span></a></li>
														...
														<li><a href=\"../../logout.php.php\"><i class='lnr lnr-exit'></i> <span>Logout</span></a></li>";
												 }
												 else
												 {
													echo "&nbsp;";
