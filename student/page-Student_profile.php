			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="notes/display.php" class=""><i class="lnr lnr-alarm"></i> <span>Notes</span></a></li>
						...
						<li><a href="Mock_Test/mock_Stud.php" class=""><i class="lnr lnr-text-format"></i> <span>Mock Test</span></a></li>
