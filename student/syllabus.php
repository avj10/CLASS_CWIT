	...
	<div id="wrapper">
		...
		<div class="sidebar">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="page-Student_profile.php" "><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="Att_1.html" ><i class="lnr lnr-chart-bars"></i> <span>Attendance</span></a></li>
						...
						<li><a href="#" class=""><i class="lnr lnr-alarm"></i> <span>Notes</span></a></li>
							<li><a href="#" class="active"><i class="lnr lnr-alarm"></i> <span>Syllabus</span></a></li>
